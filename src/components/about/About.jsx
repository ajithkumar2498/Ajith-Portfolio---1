...
import "./about.css"
import AboutImg from"../../assets/AK.jpg"
    ...
    <section className="about theme-controller" id="about">
           ...
           <div className="about__container container grid" >
                ...
                <div className="about__data">
                   ...
                   <a href="https://drive.google.com/file/d/1zz2khc8usqXSU5CH_iiNDtWEFbGcb5J4/view?usp=sharing" target="_blank" className="button button--flex">Download CV
                            <svg
                            class="button__icon"
